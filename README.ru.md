...
- флаги VoLTE и наличие P-CSCF по конкретному слоту, с явными ошибками чтения;
- изменение, проверку, сохранение и отмену черновика конфигурации.

Адрес P-CSCF не доказывает регистрацию IMS или работу звонков по LTE. Исторические строки
radio-log не считаются текущим состоянием. Подменённые файлы могут быть видны телефонии,
